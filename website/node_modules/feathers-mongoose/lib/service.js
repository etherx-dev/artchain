...
var Service = function () {
  ...
  _createClass(Service, [{
    ...
    value: function _find(params, count) {
      ...
      var q = this.Model.find(query).lean(this.lean);
      ...
      if (filters.$select && filters.$select.length) {
        ...
        if (filters.$select && _typeof(filters.$select) === 'object') {
    ...
    value: function _get(id) {
      ...
      var modelQuery = this.Model.findOne(_defineProperty({}, this.id, id));
    ...
    value: function create(data, params) {
      return this.Model.create(data).then((0, _feathersCommons.select)(params, this.id)).catch(_errorHandler2.default);
    }
  }, {
    key: 'update',
    value: function update(id, data, params) {
      ...
      var modelQuery = this.Model.findOneAndUpdate(_defineProperty({}, this.id, id), data, options);
    ...
    value: function remove(id, params) {
      ...
      return this._getOrFind(id, params).then(function (data) {
        return _this2.Model.remove(query).lean(_this2.lean).exec().then(function () {
          return data;
        }).then((0, _feathersCommons.select)(params, _this2.id));
      }).catch(_errorHandler2.default);
    }
  }]);
