...
contract Association is owned, tokenRecipient {
    ...
    function Association(token sharesAddress, uint minimumSharesToPassAVote, uint minutesForDebate) payable {
        Appraisal(sharesAddress, minimumSharesToPassAVote, minutesForDebate);
    }

    /*change rules*/
    function Appraisal(token sharesAddress, uint minimumSharesToPassAVote, uint minutesForDebate) onlyOwner {
